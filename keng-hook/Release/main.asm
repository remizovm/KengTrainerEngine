; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.50727.1 
	...
	TITLE	C:\Users\Mikhail\Documents\GitHub\KengTrainerEngine\keng-hook\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?indicator@@3_NA				; indicator
PUBLIC	?rec@@3U_D3DRECT@@A				; rec
PUBLIC	?m_font@@3PAUID3DXFont@@A			; m_font
PUBLIC	?fontRect@@3UtagRECT@@A				; fontRect
PUBLIC	?bkgColor@@3KA					; bkgColor
PUBLIC	?fontColor@@3KA					; fontColor
PUBLIC	?menu@@3PBDB					; menu
PUBLIC	??_C@_04LDDCFCMF@keng?$AA@			; `string'
_BSS	SEGMENT
...
?indicator@@3_NA DB 01H DUP (?)				; indicator
	ALIGN	4

?m_font@@3PAUID3DXFont@@A DD 01H DUP (?)		; m_font
?bkgColor@@3KA DD 01H DUP (?)				; bkgColor
?fontColor@@3KA DD 01H DUP (?)				; fontColor
_BSS	ENDS
;	COMDAT ??_C@_04LDDCFCMF@keng?$AA@
CONST	SEGMENT
??_C@_04LDDCFCMF@keng?$AA@ DB 'keng', 00H		; `string'
CONST	ENDS
_DATA	SEGMENT
?rec@@3U_D3DRECT@@A DD 0aH				; rec
	...
	DD	0a0H
	DD	0f0H
?fontRect@@3UtagRECT@@A DD 0aH				; fontRect
	DD	0aH
	DD	0a0H
	DD	0f0H
?menu@@3PBDB DD	FLAT:??_C@_04LDDCFCMF@keng?$AA@		; menu
_DATA	ENDS
...
PUBLIC	?TF@@YGKPAX@Z					; TF
PUBLIC	?KeyboardHook@@YGKPAX@Z				; KeyboardHook
PUBLIC	_DllMain@12
PUBLIC	??_C@_08KOFIJIMC@Terminal?$AA@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_08KOFIJIMC@Terminal?$AA@
CONST	SEGMENT
??_C@_08KOFIJIMC@Terminal?$AA@ DB 'Terminal', 00H	; `string'
CONST	ENDS
...
; File c:\users\mikhail\documents\github\kengtrainerengine\keng-hook\main.cpp
; Line 146
	push	ebp
	mov	ebp, esp
; Line 147
...
; Line 151
	...
	push	0
	push	0
	push	OFFSET ?KeyboardHook@@YGKPAX@Z		; KeyboardHook
	push	0
	push	0
	call	DWORD PTR __imp__CreateThread@24
$LN6@DllMain:
...
_TEXT	ENDS
; Function compile flags: /Ogtp
;	COMDAT ?KeyboardHook@@YGKPAX@Z
_TEXT	SEGMENT
_lpParam$ = 8						; size = 4
?KeyboardHook@@YGKPAX@Z PROC				; KeyboardHook, COMDAT
; File c:\users\mikhail\documents\github\kengtrainerengine\keng-hook\main.cpp
; Line 131
	push	ebx
...
; Line 136
	cmp	BYTE PTR ?indicator@@3_NA, 0		; indicator
; Line 137
	push	200					; 000000c8H
	push	500					; 000001f4H
	sete	BYTE PTR ?indicator@@3_NA		; indicator
	call	ebx
$LN1@KeyboardHo:
; Line 139
	push	100					; 00000064H
...
?KeyboardHook@@YGKPAX@Z ENDP				; KeyboardHook
_TEXT	ENDS
; Function compile flags: /Ogtp
;	COMDAT ?TF@@YGKPAX@Z
_TEXT	SEGMENT
_lpParam$ = 8						; size = 4
?TF@@YGKPAX@Z PROC					; TF, COMDAT
; File c:\users\mikhail\documents\github\kengtrainerengine\keng-hook\main.cpp
; Line 124
	call	?GetDevice9Methods@@YAXXZ		; GetDevice9Methods
; Line 125
	call	?HookDevice9Methods@@YAXXZ		; HookDevice9Methods
; Line 126
	xor	eax, eax
; Line 127
	ret	4
...
; Line 81
	...
	call	?DrawIndicator@@YAXPAX@Z		; DrawIndicator
	add	esp, 4
; Line 82
...
; Line 65
	...
	mov	DWORD PTR _d3dDevice$[ebp], 0
...
; Line 30
	...
	mov	ebp, esp
; Line 40
	cmp	DWORD PTR ?m_font@@3PAUID3DXFont@@A, 0	; m_font
	push	esi
	mov	esi, DWORD PTR _self$[ebp]
	jne	SHORT $LN2@DrawIndica
	push	OFFSET ?m_font@@3PAUID3DXFont@@A	; m_font
	push	OFFSET ??_C@_08KOFIJIMC@Terminal?$AA@
	push	0
	push	0
	push	0
	push	1
...
; Line 43
	cmp	BYTE PTR ?indicator@@3_NA, 0		; indicator
	je	SHORT $LN1@DrawIndica
; Line 47
	push	0
	push	ecx
	mov	DWORD PTR ?bkgColor@@3KA, -16777216	; bkgColor, ff000000H
	mov	DWORD PTR [esp], 1065353216		; 3f800000H
	push	-16777216				; ff000000H
	push	1
	push	OFFSET ?rec@@3U_D3DRECT@@A		; rec
	mov	DWORD PTR ?fontColor@@3KA, -1		; fontColor
	mov	eax, DWORD PTR [esi]
	push	1
	push	esi
	call	DWORD PTR [eax+172]
; Line 48
	push	DWORD PTR ?fontColor@@3KA		; fontColor
	mov	eax, DWORD PTR ?m_font@@3PAUID3DXFont@@A ; m_font
	push	0
	mov	ecx, DWORD PTR [eax]
	push	OFFSET ?fontRect@@3UtagRECT@@A		; fontRect
	push	-1
	push	DWORD PTR ?menu@@3PBDB			; menu
	push	0
	push	eax
